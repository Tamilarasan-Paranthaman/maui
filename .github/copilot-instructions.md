...
5. **commit-cherry-pick** - Applies commits from GitHub commit URLs onto the current branch using the patch-based approach
...
- User shares a GitHub commit URL → Immediately invoke **commit-cherry-pick** agent
